...
- `TimeMoE_original_fix_df_power_test_common.sh`
- `TimeMoE_original_fix_df_power_test_optim.sh`
- `TimeMoE_original_fix_df_power_forecast_common.sh`
- `TimeMoE_original_fix_df_power_forecast_optim.sh`
